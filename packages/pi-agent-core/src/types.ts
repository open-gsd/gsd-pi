 ...
 * Note: "xhigh" and "max" are only supported by selected model families. Use model thinking-level metadata
 * from @gsd/pi-ai to detect support for a concrete model.
 */
...
export interface AgentState {
	...
	model: Model<any>;
	/** GSD compat: model currently serving an in-flight inference request. */
