...
Base events are defined by [`AgentEvent`](../../pi-agent-core/src/types.ts).
See [Agent Event Metadata](../../../docs/extension-sdk/api-reference.md#agent-event-metadata)
for abort-origin handling.
